...
export default {
  ...
  data() {
    let legend = [
      Vue.t("monitor.averageDelay"),
      Vue.t("monitor.minimumDelay"),
      Vue.t("monitor.maximumDelay")
    ];
    return {
      loading: false,
      loadingOpts: utils.loadingOpts,
      title: Vue.t("monitor.systemDelay"),
      option: {
        legend: {
          selected: (v => {
            let o = {};
  ...
  methods: {
    getData(v = {}) {
      ...
      this.$ajax({
        ...
        data: JSON.stringify({
          params: {
            alias_fields: ["avg_latency", "min_latency", "max_latency"],
            fields: [
              "mean(avg_latency)",
              "mean(min_latency)",
              "mean(max_latency)"
        ...
        successFun(rtn) {
          ...
          let enArr = ["avg_latency", "min_latency", "max_latency"];
