<template>
 <div>
  ...
  <el-table
    ...
    <el-table-column v-if="columnsChecked.indexOf('conto') >= 0"
      prop="conto"
      align="left"
      label="连接到"
      min-width="100">
    </el-table-column>
    <el-table-column v-if="columnsChecked.indexOf('enableyu') >= 0"
      prop="enableyu"
      align="left"
      label="可用域"
      min-width="100">
      ...
      <template slot-scope="scope">
        <el-dropdown split-button type="info" @click="handleClick" size="small" @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="扩展卷">扩展卷</el-dropdown-item>
            <el-dropdown-item command="管理连接">管理连接</el-dropdown-item>
            <el-dropdown-item command="创建快照">创建快照</el-dropdown-item>
            <el-dropdown-item command="创建备份">创建备份</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </template>
    </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      loading:false,
      columnsChecked:["name", "desc", "size", "sta", "type", "conto", "enableyu", "move"],
      columns:[{
        prop:"name",
        label:"名称"
      }, {
